            ...
            TestSuite(
                ...
                questions=[
                    ...
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["code splitting", "lazy loading", "chunks", "bundles", "on demand"],
                    ),
                ],
            ),
            TestSuite(
                ...
                questions=[
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["heap snapshot", "memory leak", "detached", "DevTools", "allocations"],
                    ),
                    TestQuestion(
                        id="fd2",
                        ...
                        evaluation="keyword_match",
                        keywords=["layout thrash", "reflow", "offsetHeight", "batch", "requestAnimationFrame"],
                    ),
                    TestQuestion(
                        id="fd3",
                        ...
                        evaluation="keyword_match",
                        keywords=["CORS", "origin", "Access-Control-Allow-Origin", "header", "proxy"],
                    ),
                ],
            ),
        ],
            ...
            TestSuite(
                ...
                questions=[
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["HTTP methods", "stateless", "resource", "status codes", "pagination"],
                    ),
                    TestQuestion(
                        id="ba2",
                    ...
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["rate limiting", "token bucket", "sliding window", "Redis", "429"],
                    ),
                ],
            ),
            TestSuite(
                ...
                questions=[
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["SQL", "NoSQL", "ACID", "schema", "horizontal scaling", "relationships"],
                    ),
                    TestQuestion(
                        id="bd2",
                    ...
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["transaction", "atomicity", "consistency", "isolation", "durability"],
                    ),
                ],
            ),
            TestSuite(
                ...
                questions=[
                    ...
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["failover", "replica", "circuit breaker", "cached", "post-mortem"],
                    ),
                ],
            ),
        ],
...
def _make_system_design() -> Domain:
    return Domain(
        ...
        custom=True,
        aliases=["distributed systems", "scalability", "reliability", "high availability", "distributed"],
        suites=[
            TestSuite(
                ...
                questions=[
                    ...
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["eventual consistency", "replicas", "converge", "staleness", "availability"],
                    ),
                    TestQuestion(
                        id="ds3",
                        ...
                        evaluation="keyword_match",
                        keywords=["Kafka", "RabbitMQ", "event streaming", "message broker", "throughput"],
                    ),
                ],
            ),
            TestSuite(
                ...
                questions=[
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["horizontal", "vertical", "scale up", "scale out", "fault tolerance"],
                    ),
                    TestQuestion(
                        id="sc2",
                        ...
                        evaluation="keyword_match",
                        keywords=["cache-aside", "write-through", "write-behind", "invalidation", "freshness"],
                    ),
                    TestQuestion(
                        id="sc3",
                        ...
                        evaluation="keyword_match",
                        keywords=["load balancer", "horizontal", "read replicas", "Redis", "CDN", "queue"],
                    ),
                ],
            ),
            TestSuite(
                ...
                questions=[
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["circuit breaker", "cascading", "closed", "open", "half-open", "threshold"],
                    ),
                    TestQuestion(
                        id="re2",
                    ...
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["fallback", "timeout", "bulkhead", "health check", "degraded", "isolation"],
                    ),
                ],
            ),
        ],
...
def _make_architecture() -> Domain:
    return Domain(
        ...
        custom=True,
        aliases=["software architecture", "service boundaries", "deployment", "design patterns", "microservices"],
        suites=[
            TestSuite(
                ...
                questions=[
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["monolithic", "microservices", "modular", "deployable", "boundaries"],
                    ),
                    TestQuestion(
                        id="sa2",
                        ...
                        evaluation="keyword_match",
                        keywords=["DDD", "bounded context", "aggregate", "ubiquitous language", "domain"],
                    ),
                    TestQuestion(
                        id="sa3",
                        ...
                        evaluation="keyword_match",
                        keywords=["event-driven", "loose coupling", "CQRS", "event sourcing", "decoupling"],
                    ),
                ],
            ),
            TestSuite(
                ...
                questions=[
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["bounded context", "cohesive", "data ownership", "team boundaries", "split"],
                    ),
                    TestQuestion(
                        id="sb2",
                        ...
                        evaluation="keyword_match",
                        keywords=["strangler fig", "incremental", "legacy", "monolith", "migration", "rewrite"],
                    ),
                    TestQuestion(
                        id="sb3",
                        ...
                        evaluation="keyword_match",
                        keywords=["synchronous", "asynchronous", "REST", "gRPC", "queues", "coupling"],
                    ),
                ],
            ),
            TestSuite(
                ...
                questions=[
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["blue-green", "canary", "rolling", "traffic", "rollback", "incremental"],
                    ),
                    TestQuestion(
                        id="da2",
                        ...
                        evaluation="keyword_match",
                        keywords=["RPO", "RTO", "backup", "failover", "multi-region", "disaster recovery"],
                    ),
                    TestQuestion(
                        id="da3",
                        ...
                        evaluation="keyword_match",
                        keywords=["12-factor", "config", "backing services", "processes", "cloud-native", "SaaS"],
                    ),
                ],
            ),
        ],
            ...
            TestSuite(
                ...
                questions=[
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["STRIDE", "spoofing", "tampering", "repudiation", "disclosure", "elevation"],
                    ),
                    TestQuestion(
                        id="tm2",
                        ...
                        evaluation="keyword_match",
                        keywords=["multi-tenant", "trust boundary", "isolation", "RBAC", "cross-tenant"],
                    ),
                    TestQuestion(
                        id="tm3",
                        ...
                        evaluation="keyword_match",
                        keywords=["attack tree", "hierarchical", "attack vector", "goal", "techniques", "prioritize"],
                    ),
                ],
            ),
            TestSuite(
                ...
                questions=[
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["OWASP", "injection", "XSS", "authentication", "access control", "SSRF"],
                    ),
                    TestQuestion(
                        id="sc_sec2",
                        ...
                        evaluation="keyword_match",
                        keywords=["SQL injection", "parameterized", "prepared statements", "ORM", "validation"],
                    ),
                    TestQuestion(
                        id="sc_sec3",
            ...
            TestSuite(
                ...
                questions=[
                    TestQuestion(
                        ...
                        evaluation="keyword_match",
                        keywords=["HTTPS", "JWT", "rate limiting", "CORS", "input validation", "logging"],
                    ),
                    TestQuestion(
                        id="as2",
                        ...
                        evaluation="keyword_match",
                        keywords=["preparation", "identification", "containment", "eradication", "recovery", "lessons"],
                    ),
                    TestQuestion(
                        id="as3",
                        ...
                        evaluation="keyword_match",
                        keywords=["defense in depth", "layers", "firewall", "WAF", "encryption", "monitoring"],
                    ),
                ],
            ),
        ],
...
def seed_domains(
    reset: bool = typer.Option(
        False, "--reset", help="Delete all custom domains before seeding."
    ),
) -> None:
