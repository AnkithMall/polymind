...
### From PyPI (global install)

```bash
# Install globally with uv
uv tool install polymind-ai

# Or install globally with pipx
pipx install polymind-ai

# Or install globally with pip
pip install polymind-ai --break-system-packages
```
...
```bash
# Update with uv
uv tool upgrade polymind-ai

# Or update with pipx
pipx upgrade polymind-ai

# Or update with pip
pip install --upgrade polymind-ai --break-system-packages
```
...
```bash
# Uninstall with uv
uv tool uninstall polymind-ai

# Or uninstall with pipx
pipx uninstall polymind-ai

# Or uninstall with pip
pip uninstall polymind-ai
```
...
# Search for models
polymind model search "code generation"

# Download a model
polymind model download bartowski/Llama-3.2-3B-Instruct-GGUF \
...
polymind runtime optimize -m <model_id>

# Run interactive chat
polymind runtime run -m <model_id>
...
make build            # Build distribution (sdist + wheel)
```
